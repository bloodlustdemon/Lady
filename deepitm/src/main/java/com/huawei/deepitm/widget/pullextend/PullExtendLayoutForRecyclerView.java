...
import com.huawei.deepitm.widget.pullextend.ExtendLayout;
import com.huawei.deepitm.widget.pullextend.IExtendLayout;
import com.huawei.deepitm.widget.pullextend.IPullToExtend;
...
//    NestedScrollView mRefreshableView;
    /**
     * 平滑滚动的Runnable
     */
...
//                mRefreshableView = (NestedScrollView) getChildAt(1);
                mRefreshableView = (RecyclerView) getChildAt(1);
            } else {
//                mRefreshableView = (NestedScrollView) getChildAt(0);
